...
export function cmp_im(value: byte) {
    ...
    comp.cpu.reg.N = (result & 0x80) > 0;
}

export function cmp_zpg(value: byte) {
    const result = comp.cpu.reg.A - comp.bus.readByte(value);
...
export function cmp_zpgx(value: byte) {
    const result = comp.cpu.reg.A - comp.bus.readByte(value + comp.cpu.reg.X);
...
export function cmp_absy(value: byte) {
    const result = comp.cpu.reg.A - comp.bus.readByte(value + comp.cpu.reg.Y);
...
export function cmp_indx(value: byte) {
    ...
    const result = comp.cpu.reg.A - comp.bus.readByte(addr);
...
export function cpx_zpg(value: byte) {
    const result = comp.cpu.reg.X - comp.bus.readByte(value);
...
export function cpy_zpg(value: byte) {
    const result = comp.cpu.reg.Y - comp.bus.readByte(value);
...
export function sbc_abs(value: byte) {
    const result = comp.cpu.reg.A - comp.bus.readByte(value) - (1 - (comp.cpu.reg.C ? 1 : 0));
...
export function sbc_absx(value: byte) {
    const result = comp.cpu.reg.A - comp.bus.readByte(value + comp.cpu.reg.X) - (1 - (comp.cpu.reg.C ? 1 : 0));
...
export function sbc_absy(value: byte) {
    const result = comp.cpu.reg.A - comp.bus.readByte(value + comp.cpu.reg.Y) - (1 - (comp.cpu.reg.C ? 1 : 0));
